...
document.getElementById("random-line-color").addEventListener("click", function() {
    ...
    particlesConfig.particles.line_linked.color = randomColor;
    particlesJS("particles-js", particlesConfig);
});
...
document.getElementById("change-shape").addEventListener("click", function() {
    ...
    particlesConfig.particles.shape.type = randomShape;

    if (randomShape === "polygon") {
        particlesConfig.particles.shape.polygon.nb_sides = Math.floor(Math.random() * 6) + 3; // من 3 إلى 8 جوانب
    }
