        ...
        document.getElementById("changeColor").addEventListener("click", function() {
            ...
            particlesJS("particles-js", {
                particles: {
                    ...
                    opacity: { value: 0.5, random: false, anim: { enable: false } },
                    size: { value: 4, random: true, anim: { enable: false } },
                    line_linked: { enable: true, distance: 150, color: selectedColor, opacity: 0.4, width: 1 },
                    move: { enable: true, speed: 6, direction: "none", random: false, straight: false, out_mode: "out" }
                },
                interactivity: {
                    detect_on: "canvas",
        ...
        // تغيير شكل الجزيئات عند الضغط على زر
        document.getElementById("changeShape").addEventListener("click", function() {
            // تغيير الشكل بناءً على الشكل الحالي
            currentShape = currentShape === "circle" ? "edge" : "circle"; // يمكن إضافة أشكال أخرى هنا
