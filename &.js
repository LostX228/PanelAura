  // إعداد particles.js
        ...
        // تحديث الجزيئات وعرض الرسالة
        function updateParticlesAndMessage() {
            initParticles(currentShape, currentColor);
            const resultMessage = document.getElementById("resultMessage");
            resultMessage.classList.remove("hidden");
            resultMessage.innerText = `اللون المختار: ${currentColor} | الشكل المختار: ${currentShape}`;
        }
