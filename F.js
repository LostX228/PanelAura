 // إعداد particles.js
    ...
    document.getElementById("changeColor").addEventListener("click", function() {
        ...
        // تحديث لون الخطوط فقط دون تغيير أي إعدادات أخرى
        const particlesInstance = particlesJS.particles;
        particlesInstance.line_linked.color = selectedColor; // تغيير لون الخطوط

        // إعادة رسم الجزيئات
        particlesJS.fn.vendors.start();
    });
